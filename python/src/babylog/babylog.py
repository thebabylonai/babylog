...
class Babylog:
    ...
    def _log(
        ...
        try:
            ...
            single_image_prediction.raw_image.CopyFrom(
                ndarray_to_image(array_=image, compress=compress)
            )
            ...
            if prediction is not None:
                single_image_prediction.prediction = ndarray_to_bytes(
                    array_=prediction, compress=compress
                )
